...
ActiveRecord::Schema.define(version: 2021_03_21_013556) do
  ...
  create_table "deliveries", force: :cascade do |t|
    ...
    t.string "telephone_number", limit: 8, null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  create_table "orders", force: :cascade do |t|
    ...
    t.string "delivery_telephone_number", limit: 8, null: false
